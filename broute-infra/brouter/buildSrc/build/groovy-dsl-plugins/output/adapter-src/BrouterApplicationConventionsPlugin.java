...
/**
 * Precompiled brouter.application-conventions script plugin.
 **/
public class BrouterApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BrouterApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("brouter.java-conventions");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BrouterApplicationConventions").asSubclass(BasicScript.class);
