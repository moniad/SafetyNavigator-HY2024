...
/**
 * Precompiled brouter.java-conventions script plugin.
 **/
public class BrouterJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BrouterJavaConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("pmd");
            target.getPluginManager().apply("brouter.version-conventions");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BrouterJavaConventions").asSubclass(BasicScript.class);
