...
/**
 * Precompiled brouter.version-conventions script plugin.
 **/
public class BrouterVersionConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BrouterVersionConventions").asSubclass(BasicScript.class);
